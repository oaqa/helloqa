...
public class OAQATop_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.dso.model.OAQATop");
  ...
  public String getComponentId(int addr) {
      ...
      jcas.throwFeatMissing("componentId", "org.oaqa.dso.model.OAQATop");
  ...
  public float getProbability(int addr) {
      ...
      jcas.throwFeatMissing("probability", "org.oaqa.dso.model.OAQATop");
  ...
  public String getImplementingWrapper(int addr) {
      ...
      jcas.throwFeatMissing("implementingWrapper", "org.oaqa.dso.model.OAQATop");
