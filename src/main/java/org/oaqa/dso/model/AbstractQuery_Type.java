...
public class AbstractQuery_Type extends OAQATop_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.dso.model.AbstractQuery");
  ...
  public int getConcepts(int addr) {
      ...
      jcas.throwFeatMissing("concepts", "org.oaqa.dso.model.AbstractQuery");
