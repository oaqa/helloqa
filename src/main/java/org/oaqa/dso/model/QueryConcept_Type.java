...
public class QueryConcept_Type extends OAQATop_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.dso.model.QueryConcept");
  ...
  public int getNeTypes(int addr) {
      ...
      jcas.throwFeatMissing("neTypes", "org.oaqa.dso.model.QueryConcept");
  ...
  public String getConceptType(int addr) {
      ...
      jcas.throwFeatMissing("conceptType", "org.oaqa.dso.model.QueryConcept");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "org.oaqa.dso.model.QueryConcept");
  ...
  public String getOriginalText(int addr) {
      ...
      jcas.throwFeatMissing("originalText", "org.oaqa.dso.model.QueryConcept");
  ...
  public int getOperator(int addr) {
      ...
      jcas.throwFeatMissing("operator", "org.oaqa.dso.model.QueryConcept");
  ...
  public int getOperatorArgs(int addr) {
      ...
      jcas.throwFeatMissing("operatorArgs", "org.oaqa.dso.model.QueryConcept");
  ...
  public int getPos(int addr) {
      ...
      jcas.throwFeatMissing("pos", "org.oaqa.dso.model.QueryConcept");
  ...
  public QueryConcept_Type(JCas jcas, Type casType) {
    ...
    casFeat_conceptType = jcas.getRequiredFeatureDE(casType, "conceptType", "org.oaqa.dso.model.ConceptType", featOkTst);
    ...
    casFeat_operator = jcas.getRequiredFeatureDE(casType, "operator", "org.oaqa.dso.model.QueryOperator", featOkTst);
