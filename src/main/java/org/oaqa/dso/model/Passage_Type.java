...
public class Passage_Type extends SearchResult_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.dso.model.Passage");
  ...
  public String getTitle(int addr) {
      ...
      jcas.throwFeatMissing("title", "org.oaqa.dso.model.Passage");
  ...
  public String getDocId(int addr) {
      ...
      jcas.throwFeatMissing("docId", "org.oaqa.dso.model.Passage");
  ...
  public int getBegin(int addr) {
      ...
      jcas.throwFeatMissing("begin", "org.oaqa.dso.model.Passage");
  ...
  public int getEnd(int addr) {
      ...
      jcas.throwFeatMissing("end", "org.oaqa.dso.model.Passage");
