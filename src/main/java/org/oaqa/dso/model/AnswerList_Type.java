...
public class AnswerList_Type extends OAQATop_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.dso.model.AnswerList");
  ...
  public int getAnswerList(int addr) {
      ...
      jcas.throwFeatMissing("answerList", "org.oaqa.dso.model.AnswerList");
  ...
  public boolean getNilAnswer(int addr) {
      ...
      jcas.throwFeatMissing("nilAnswer", "org.oaqa.dso.model.AnswerList");
  ...
  public int getFeatureLabels(int addr) {
      ...
      jcas.throwFeatMissing("featureLabels", "org.oaqa.dso.model.AnswerList");
