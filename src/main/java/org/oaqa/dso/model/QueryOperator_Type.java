...
public class QueryOperator_Type extends OAQATop_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.dso.model.QueryOperator");
  ...
  public String getName(int addr) {
      ...
      jcas.throwFeatMissing("name", "org.oaqa.dso.model.QueryOperator");
  ...
  public int getArgs(int addr) {
      ...
      jcas.throwFeatMissing("args", "org.oaqa.dso.model.QueryOperator");
  ...
  public QueryOperator_Type(JCas jcas, Type casType) {
    ...
    casFeat_name = jcas.getRequiredFeatureDE(casType, "name", "org.oaqa.dso.model.QueryOperatorName", featOkTst);
