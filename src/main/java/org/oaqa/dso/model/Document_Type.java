...
public class Document_Type extends SearchResult_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.dso.model.Document");
  ...
  public String getTitle(int addr) {
      ...
      jcas.throwFeatMissing("title", "org.oaqa.dso.model.Document");
  ...
  public String getDocId(int addr) {
      ...
      jcas.throwFeatMissing("docId", "org.oaqa.dso.model.Document");
