...
public class CandidateAnswerOccurrence_Type extends OAQAAnnotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.dso.model.CandidateAnswerOccurrence");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "org.oaqa.dso.model.CandidateAnswerOccurrence");
  ...
  public String getMentionType(int addr) {
      ...
      jcas.throwFeatMissing("mentionType", "org.oaqa.dso.model.CandidateAnswerOccurrence");
  ...
  public int getSource(int addr) {
      ...
      jcas.throwFeatMissing("source", "org.oaqa.dso.model.CandidateAnswerOccurrence");
  ...
  public int getSourceBegin(int addr) {
      ...
      jcas.throwFeatMissing("sourceBegin", "org.oaqa.dso.model.CandidateAnswerOccurrence");
  ...
  public int getSourceEnd(int addr) {
      ...
      jcas.throwFeatMissing("sourceEnd", "org.oaqa.dso.model.CandidateAnswerOccurrence");
  ...
  public CandidateAnswerOccurrence_Type(JCas jcas, Type casType) {
    ...
    casFeat_source = jcas.getRequiredFeatureDE(casType, "source", "org.oaqa.dso.model.SearchResult", featOkTst);
