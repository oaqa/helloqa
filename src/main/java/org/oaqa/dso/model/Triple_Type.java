...
public class Triple_Type extends OAQATop_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.dso.model.Triple");
  ...
  public String getSubject(int addr) {
      ...
      jcas.throwFeatMissing("subject", "org.oaqa.dso.model.Triple");
  ...
  public String getPredicate(int addr) {
      ...
      jcas.throwFeatMissing("predicate", "org.oaqa.dso.model.Triple");
  ...
  public String getObject(int addr) {
      ...
      jcas.throwFeatMissing("object", "org.oaqa.dso.model.Triple");
  ...
  public boolean getIsObjUri(int addr) {
      ...
      jcas.throwFeatMissing("isObjUri", "org.oaqa.dso.model.Triple");
