...
public class TrecQuestion_Type extends Question_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.dso.model.TrecQuestion");
  ...
  public String getQType(int addr) {
      ...
      jcas.throwFeatMissing("qType", "org.oaqa.dso.model.TrecQuestion");
  ...
  public TrecQuestion_Type(JCas jcas, Type casType) {
    ...
    casFeat_qType = jcas.getRequiredFeatureDE(casType, "qType", "org.oaqa.dso.model.QuestionClass", featOkTst);
