...
public class Focus_Type extends OAQAAnnotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.dso.model.Focus");
  ...
  public int getPredicate(int addr) {
      ...
      jcas.throwFeatMissing("predicate", "org.oaqa.dso.model.Focus");
  ...
  public String getLabel(int addr) {
      ...
      jcas.throwFeatMissing("label", "org.oaqa.dso.model.Focus");
