...
public class Search_Type extends OAQATop_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.dso.model.Search");
  ...
  public String getQuery(int addr) {
      ...
      jcas.throwFeatMissing("query", "org.oaqa.dso.model.Search");
  ...
  public int getHitList(int addr) {
      ...
      jcas.throwFeatMissing("hitList", "org.oaqa.dso.model.Search");
  ...
  public int getAbstractQuery(int addr) {
      ...
      jcas.throwFeatMissing("abstractQuery", "org.oaqa.dso.model.Search");
  ...
  public String getSearchId(int addr) {
      ...
      jcas.throwFeatMissing("searchId", "org.oaqa.dso.model.Search");
  ...
  public Search_Type(JCas jcas, Type casType) {
    ...
    casFeat_abstractQuery = jcas.getRequiredFeatureDE(casType, "abstractQuery", "org.oaqa.dso.model.AbstractQuery", featOkTst);
