...
public class AnswerType_Type extends OAQAAnnotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.dso.model.AnswerType");
  ...
  public String getLabel(int addr) {
      ...
      jcas.throwFeatMissing("label", "org.oaqa.dso.model.AnswerType");
  ...
  public int getTargetType(int addr) {
      ...
      jcas.throwFeatMissing("targetType", "org.oaqa.dso.model.AnswerType");
