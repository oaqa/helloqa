...
public class Predicate_Type extends OAQAAnnotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.dso.model.Predicate");
  ...
  public int getArguments(int addr) {
      ...
      jcas.throwFeatMissing("arguments", "org.oaqa.dso.model.Predicate");
  ...
  public int getArgumentLabels(int addr) {
      ...
      jcas.throwFeatMissing("argumentLabels", "org.oaqa.dso.model.Predicate");
  ...
  public int getSources(int addr) {
      ...
      jcas.throwFeatMissing("sources", "org.oaqa.dso.model.Predicate");
  ...
  public int getParse(int addr) {
      ...
      jcas.throwFeatMissing("parse", "org.oaqa.dso.model.Predicate");
  ...
  public String getSemanticType(int addr) {
      ...
      jcas.throwFeatMissing("semanticType", "org.oaqa.dso.model.Predicate");
  ...
  public String getPartOfSpeech(int addr) {
      ...
      jcas.throwFeatMissing("partOfSpeech", "org.oaqa.dso.model.Predicate");
  ...
  public String getLemmaForm(int addr) {
      ...
      jcas.throwFeatMissing("lemmaForm", "org.oaqa.dso.model.Predicate");
  ...
  public boolean getIsMainReference(int addr) {
      ...
      jcas.throwFeatMissing("isMainReference", "org.oaqa.dso.model.Predicate");
  ...
  public boolean getIsVariable(int addr) {
      ...
      jcas.throwFeatMissing("isVariable", "org.oaqa.dso.model.Predicate");
  ...
  public String getDeterminer(int addr) {
      ...
      jcas.throwFeatMissing("determiner", "org.oaqa.dso.model.Predicate");
