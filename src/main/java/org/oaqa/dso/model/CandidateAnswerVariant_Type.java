...
public class CandidateAnswerVariant_Type extends OAQATop_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.dso.model.CandidateAnswerVariant");
  ...
  public int getOccurrences(int addr) {
      ...
      jcas.throwFeatMissing("occurrences", "org.oaqa.dso.model.CandidateAnswerVariant");
  ...
  public String getCandidateId(int addr) {
      ...
      jcas.throwFeatMissing("candidateId", "org.oaqa.dso.model.CandidateAnswerVariant");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "org.oaqa.dso.model.CandidateAnswerVariant");
  ...
  public int getFeatures(int addr) {
      ...
      jcas.throwFeatMissing("features", "org.oaqa.dso.model.CandidateAnswerVariant");
  ...
  public int getSupportingEvidenceSearches(int addr) {
      ...
      jcas.throwFeatMissing("supportingEvidenceSearches", "org.oaqa.dso.model.CandidateAnswerVariant");
  ...
  public int getAlternativeNames(int addr) {
      ...
      jcas.throwFeatMissing("alternativeNames", "org.oaqa.dso.model.CandidateAnswerVariant");
  ...
  public String getUri(int addr) {
      ...
      jcas.throwFeatMissing("uri", "org.oaqa.dso.model.CandidateAnswerVariant");
  ...
  public String getDocId(int addr) {
      ...
      jcas.throwFeatMissing("docId", "org.oaqa.dso.model.CandidateAnswerVariant");
