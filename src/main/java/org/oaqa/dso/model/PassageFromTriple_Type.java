...
public class PassageFromTriple_Type extends Passage_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.dso.model.PassageFromTriple");
  ...
  public int getSourceTriple(int addr) {
      ...
      jcas.throwFeatMissing("sourceTriple", "org.oaqa.dso.model.PassageFromTriple");
  ...
  public PassageFromTriple_Type(JCas jcas, Type casType) {
    ...
    casFeat_sourceTriple = jcas.getRequiredFeatureDE(casType, "sourceTriple", "org.oaqa.dso.model.Triple", featOkTst);
